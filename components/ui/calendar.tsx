...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-white dark:bg-zinc-950 rounded-xl", className)}
      classNames={{
        ...
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded-lg !opacity-100",
