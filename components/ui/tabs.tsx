...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg border-2 border-border bg-main p-1 text-mtext",
      className,
    )}
    {...props}
  />
